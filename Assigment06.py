...
# IMarshall,2/19/2023,Modified code to complete assignment 06
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def remove_data_from_list(task, list_of_rows):
        ...
        return list_of_rows'''
        # Despite returning single print statement in test run, unable to duplicate
        # Abandoned in favor of boolean flag method demonstrated in last weeks assignment
